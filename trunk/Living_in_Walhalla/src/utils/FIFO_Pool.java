...
public class FIFO_Pool<T> {
	 ...
	 * 
	 * @param flushPool
	 *            true si vous préférez que les elements soit effacé plutôt que
	 *            remit dans le pool
	 */
	...
	public static void main(String args[]) {
		FIFO_Pool<String> lst = new FIFO_Pool<String>();
		lst.add("1");
		lst.add("2");
		lst.add("3");
		lst.add("4");
